...
export default function UserDashboard() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 4 }, width: '100%', maxWidth: 1200, mx: 'auto' }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 2, justifyContent: 'center', alignItems: 'center', mb: 2 }}>
        <Button variant="contained" color="primary" size="large" href="/user/file-complaint" sx={{ minWidth: 180 }}>
          File New Complaint
        </Button>
        <Button variant="outlined" color="primary" size="large" href="/user/status" sx={{ minWidth: 180 }}>
